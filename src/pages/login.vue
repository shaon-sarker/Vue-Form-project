        ...
        <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
          <div class="mb-4">
            ...
            <input
              ...
              id="username" v-model="login.username" type="text" placeholder="Username">
          </div>
          <div class="mb-6">
            ...
            <input
              ...
              id="password" v-model="login.password" type="password" placeholder="******************">
          ...
          <div class="flex items-center justify-between">
            ...
            <router-link to="/register"
              class="inline-block align-baseline font-bold text-sm text-orange-600 hover:text-orange-800">Or
...
function loginUser() {
  const formdata = localStorage.getItem('mydata')
